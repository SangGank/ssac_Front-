...
> - 인라인 요소 : 다른 인라인 요소, 콘텐츠는 포함 가능, 블록요소는 포함 불가능
...
> - 하나의 HTML Elemnet에 id이름을 여러 개 붙일 수 없음
...
> width/height 기본특성
>
> - 블럭 요소 : width는 부모 요소에 맞춰져서 채워짐, height는 자식요소에 맞춰짐.
> - 인라인 요소 : width/height 적용되지 않음 - 레이아웃 구성 용도로 사용되지 않음.
